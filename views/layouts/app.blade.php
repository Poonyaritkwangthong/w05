...
<body>
     ...
     <div aria-label="card" class="p-8 rounded-3xl bg-white max-w-sm w-full">
          <img class="mx-auto" src="@yield('image')" alt="">
          <p class="text-center text-2xl">@yield('name')</p>
       ...
       <div aria-label="content" class="mt-9 grid gap-2.5">
         <a href="{{ url('/bio') }}">
           ...
           >
             ...
             <div class="flex flex-col flex-1">
               <h3 class="text-sm font-medium">Monkey</h3>
         ...
         <a href="{{ url('/air') }}">
           ...
           >
             ...
             <div class="flex flex-col flex-1">
               <h3 class="text-sm font-medium">Tamandua</h3>
               <div class="divide-x divide-gray-200 mt-auto">
                 <span
                   class="inline-block px-3 text-xs leading-none text-gray-400 font-normal first:pl-0"
                   >1 unit</span
         ...
         <a href="{{ url('/wifi') }}">
           ...
           >
             ...
             <div class="flex flex-col flex-1">
               <h3 class="text-sm font-medium">Dog</h3>
               <div class="divide-x divide-gray-200 mt-auto">
                 <span
                   class="inline-block px-3 text-xs leading-none text-gray-400 font-normal first:pl-0"
                   >2 unit</span
